    ...
    <div>
      <div className='container'>
        ...
        <div className='flex justify-between mt-20'>
          <div className=''>
            <p className='max-w-96 text-2xl text-gray-800 leading-10'>In collaboration with startups, we have learned how to create a creative and functional user interface for mobile applications.</p>
            <div className='w-full'>
              {cards.map((card)=>(
                <div className='w-1/3 h-20 bg-blue-100 rounded'>
                  <Image className='m-2' src={card.src} alt={card.alt} width={32} height={32}/>
